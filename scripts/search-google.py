#!/usr/bin/env python3
# ca-pay-hub/scripts/search-google.py
# Google Careers scraper for CA. USD salary: '$194,000 - $199,000 USD' or 'USD 194,000 – 199,000'

LOG_FILE  = "/Users/clawii/ca-pay-hub/scripts/google.log"
LOCK_FILE = "/Users/clawii/ca-pay-hub/scripts/.google.lock"

REGION_NAME      = 'CA'
SEARCH_LOCATIONS = [
    ("San Francisco California", "San Francisco, CA"),
    ("Los Angeles California", "Los Angeles, CA"),
    ("Mountain View California", "Mountain View, CA"),
    ("San Jose California", "San Jose, CA"),
    ("Sunnyvale California", "Sunnyvale, CA"),
]
REGION_TERMS     = ['san francisco', 'los angeles', 'mountain view', 'palo alto', 'menlo park', 'santa clara', 'cupertino', 'sunnyvale', 'irvine', 'san diego', 'san jose', 'redwood city', 'sacramento', 'oakland', 'berkeley', ', ca,', ', ca ', 'california']
NON_REGION_TERMS = []
CITY_MAP         = {'san francisco': 'San Francisco, CA', 'los angeles': 'Los Angeles, CA', 'mountain view': 'Mountain View, CA', 'palo alto': 'Palo Alto, CA', 'santa clara': 'Santa Clara, CA', 'sunnyvale': 'Sunnyvale, CA', 'irvine': 'Irvine, CA', 'san diego': 'San Diego, CA', 'san jose': 'San Jose, CA', 'redwood city': 'Redwood City, CA', 'oakland': 'Oakland, CA'}
