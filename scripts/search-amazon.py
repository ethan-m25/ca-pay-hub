#!/usr/bin/env python3
"""
ca-pay-hub/scripts/search-amazon.py
Amazon Jobs scraper — CA edition.

Strategy: Query amazon.jobs/en/search.json for CA locations.
...
LOG_FILE  = os.path.expanduser("~/ca-pay-hub/scripts/amazon.log")
LOCK_FILE = os.path.expanduser("~/ca-pay-hub/scripts/.amazon.lock")
...
QUERY_LOCATIONS = ['San Francisco, California, USA', 'Seattle, Washington, USA', 'Los Angeles, California, USA', 'San Jose, California, USA', 'San Diego, California, USA', 'Virtual Location - California, USA']

REGION_TERMS = ['california', 'san francisco', 'los angeles', 'san jose', 'san diego', 'oakland', 'sacramento', 'silicon valley', 'palo alto', 'mountain view', 'sunnyvale', 'santa clara', ', ca']

CITY_MAP = {'san francisco': 'San Francisco, CA', 'los angeles': 'Los Angeles, CA', 'san jose': 'San Jose, CA', 'san diego': 'San Diego, CA', 'oakland': 'Oakland, CA', 'palo alto': 'Palo Alto, CA', 'mountain view': 'Mountain View, CA', 'sunnyvale': 'Sunnyvale, CA', 'santa clara': 'Santa Clara, CA'}
...
def main():
    ...
    log("=== Amazon Jobs CA scraper started ===")
    ...
    log(f"=== Amazon CA scraper complete: {total_found} new jobs ===")
    return 0
