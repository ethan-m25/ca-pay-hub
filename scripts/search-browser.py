#!/usr/bin/env python3
"""
ca-pay-hub/scripts/search-browser.py
...
Run: python3 ~/ca-pay-hub/scripts/search-browser.py
"""
...
LOG_FILE    = os.path.expanduser("~/ca-pay-hub/scripts/browser.log")
LOCK_FILE   = os.path.expanduser("~/ca-pay-hub/scripts/.browser.lock")
REGION_NAME = 'CA'

EXA_QUERIES = ['site:jobs.apple.com California 2026 "salary range" "$" engineer OR software OR specialist', 'site:careers.google.com California 2026 "salary range" "$" engineer OR analyst OR manager', '"Meta" OR "Salesforce" OR "Adobe" California 2026 "salary range" "$" engineer OR manager', '"Netflix" OR "Lyft" OR "Uber" OR "Airbnb" California 2026 "salary range" "$" engineer OR manager', 'site:intel.com/jobs California 2026 "salary range" "$" engineer OR analyst', '"Qualcomm" OR "Broadcom" OR "NVIDIA" California 2026 "salary range" "$" engineer OR director', '"Wells Fargo" OR "JPMorgan" "San Francisco" OR "Los Angeles" 2026 "salary range" "$" analyst OR manager', '"Disney" OR "Warner Bros" "Los Angeles" 2026 "salary range" "$" analyst OR manager OR engineer', 'site:jobs.ca.gov "salary range" 2026 analyst OR manager OR specialist', 'California employer 2026 "salary range" "$" site:jobs.lever.co OR site:job-boards.greenhouse.io OR site:jobs.ashby.com', '"San Francisco" OR "Los Angeles" 2026 "salary range" "$100,000" OR "$120,000" OR "$150,000" job -site:glassdoor.com -site:indeed.com']
