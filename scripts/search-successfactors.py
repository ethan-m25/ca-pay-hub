#!/usr/bin/env python3
# ca-pay-hub/scripts/search-successfactors.py
# CA SB 1162 — salary range required in all postings (15+ employees, eff. Jan 1 2023)

LOG_FILE  = "/Users/clawii/ca-pay-hub/scripts/successfactors.log"
LOCK_FILE = "/Users/clawii/ca-pay-hub/scripts/.successfactors.lock"
...
SEED_PORTALS = load_successfactors_seeds('ca')
REGION_TERMS    = ['san francisco', 'los angeles', 'mountain view', 'palo alto', 'menlo park', 'santa clara', 'cupertino', 'sunnyvale', 'irvine', 'san diego', 'los gatos', 'burlingame', 'sacramento', 'redwood city', 'san mateo', 'oakland', 'berkeley', 'san jose', 'emeryville', ', ca,', ', ca ', 'california']
NON_REGION_TERMS = []
CITY_MAP        = {'san francisco': 'San Francisco, CA', 'los angeles': 'Los Angeles, CA', 'mountain view': 'Mountain View, CA', 'palo alto': 'Palo Alto, CA', 'menlo park': 'Menlo Park, CA', 'santa clara': 'Santa Clara, CA', 'cupertino': 'Cupertino, CA', 'sunnyvale': 'Sunnyvale, CA', 'irvine': 'Irvine, CA', 'san diego': 'San Diego, CA', 'san jose': 'San Jose, CA', 'redwood city': 'Redwood City, CA', 'sacramento': 'Sacramento, CA', 'oakland': 'Oakland, CA'}
DEFAULT_LOCATION = 'California, CA'
SALARY_MIN      = 30000
SALARY_MAX      = 1500000
