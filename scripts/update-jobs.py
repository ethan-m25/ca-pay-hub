#!/usr/bin/env python3
"""
ca-pay-hub/scripts/update-jobs.py
Daily job data updater — NY Pay Hub edition.

Reads raw JSONL files from ~/.openclaw/shared/ca-jobs-raw-*.txt,
